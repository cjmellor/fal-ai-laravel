...
class GetAnalyticsRequest extends Request
{
    protected Method $method = Method::GET;

    /**
     * @param  array<string>  $endpointIds  Filter by specific endpoint ID(s) (1-50, required)
     * @param  array<string>  $expand  Metrics to include: 'time_series', 'request_count', 'success_count', 'user_error_count', 'error_count', 'p50_prepare_duration', 'p75_prepare_duration', 'p90_prepare_duration', 'p50_duration', 'p75_duration', 'p90_duration'
    ...
    public function __construct(
        ...
        protected readonly array $expand = ['time_series', 'request_count'],
